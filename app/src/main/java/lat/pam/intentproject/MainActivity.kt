    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == TEXT_REQUEST) {
            if (resultCode == RESULT_OK) {
                ...
                mReplyHeadTextView.visibility = View.VISIBLE // Menampilkan header
                mReplyTextView.text = reply // Menampilkan pesan balasan
                mReplyTextView.visibility = View.VISIBLE // Menampilkan pesan teks
            }
        }
    }
}
